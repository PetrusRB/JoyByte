  ...
  const buttons = useMemo(
    () =>
      providers.map((provider) => (
        <Tooltip
          key={provider}
          label={`${AuthTrans("Sign in with")} ${provider}`}
        >
          <Button
            key={provider}
            ...
            size="md"
            radius="xl"
            className="bg-transparent text-gray-800 border-0 rounded-full font-medium transition-all duration-200 hover:scale-105"
          >
        ...
        <div className="grid lg:grid-cols-2 gap-0 bg-transparent rounded-3xl overflow-hidden min-h-[600px]">
          ...
          <div className="flex flex-col justify-center p-8 lg:p-12 bg-transparent">
            <div className="max-w-md mx-auto w-full">
              ...
              <div className="space-y-4">
                ...
                <Input
                  type="password"
                  placeholder="Uma senha aleatoria aqui."
                  className="w-full h-12"
                />
              </div>
              {/* Terms */}
          ...
          <div className="relative bg-gradient-to-br from-amber-400 via-orange-400 to-red-400 p-8 lg:p-12 flex items-center justify-center">
            ...
            <div className="absolute inset-0 overflow-hidden">
              ...
              <div
                className="absolute bottom-20 left-20 w-16 h-16 bg-white/15 rounded-full animate-pulse"
                style={{ animationDelay: "1s" }}
              ></div>
              <div
                className="absolute bottom-32 right-12 w-8 h-8 bg-white/25 rounded-full animate-bounce"
            ...
            <div className="relative z-10 text-center text-white">
              <div className="mb-8">
                ...
                <p className="text-xl text-white/80 leading-relaxed max-w-md mx-auto">
                  Junte-se a milhares de usuários que já descobriram uma nova
                  forma de se conectar
                </p>
              </div>
